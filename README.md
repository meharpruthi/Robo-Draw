RoboDraw (Image → SVG → G-code Drawing Robot)
...
Image Processing Pipeline (Python)
      ↓
Stroke Generation (Contours + Hatching + Noise)
      ↓
SVG (virtual representation)
      ↓
G-code Generation
      ↓
GRBL Controller (Arduino)
      ↓
CNC Plotter + Servo Pen
      ↓
Physical Drawing
